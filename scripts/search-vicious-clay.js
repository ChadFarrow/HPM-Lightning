...
// Search for Vicious Clay
async function searchViciousClay() {
  try {
    const headers = generateAuthHeaders();

    const searchUrl = `${API_URL}/search/byterm?q=Vicious%20Clay&max=50`;

    console.log('Searching for Vicious Clay...');
    ...
    console.log(`Found ${feeds.length} feed(s) for Vicious Clay:\n`);
